...
import case_study_mobile_banner from "../images/portfolio/mobile_size_edu.jpg";
...
const EducationService = () => {
  ...
  return (
    <>
      <>
        <Helmet>
          <title>NovaTales - Digital Marketing Agency for Education</title>
          <meta
            name="description"
              ...
              <div className="col-lg-6">
                <div data-aos="fade-up" className="service-para">
                  ...
                  <div className="healthcareTopPara">
                    ...
                    university, or skill-training centre, digital visibility is
                    no longer optional. At NovaTales, we combine deep domain
                    understanding of the education sector with full-stack
              ...
              <div className="col-lg-6 d-flex justify-content-center justify-content-md-start">
                ...
                >
                  ...
                  <div className="col-md-10 media-body">
                    <h4 className="px-2 px-md-0 pt-2 educatation_h">
                    ...
                    >
                      ...
                      study-abroad pathways. We map personas (students, parents,
                      career-counsellors) and analyse competition and digital
                      behaviour.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="col-md-10 media-body">
                    ...
                    >
                      ...
                      digital presence? We craft a compelling value proposition
                      (“Why us?”) that resonates with students and parents
                      alike, define key brand pillars, and ensure consistent
                      messaging across web, social and offline touch-points.
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="col-md-10 media-body">
                    ...
                    <ul className="listPara">
                      ...
                      <li className="listPara-li">
                        <span></span> Conversion-focused landing pages: enquiry
                        forms, brochures, scholarships, virtual-tour
                        registrations;
                      </li>
                      <li className="listPara-li">
                ...
                >
                  <div className="col-12 media-image col-md-2 d-flex justify-content-center justify-content-md-center align-items-start">
                    <img
                      ...
                      alt="Content Marketing & Engagement icon"
                      width="110%"
                    />
                  </div>
                  <div className="col-md-10 media-body">
                    ...
                    >
                      Students today research online first. Our content strategy
                      includes:
                    </p>
                    <ul className="listPara">
                      <li className="listPara-li">
                ...
                >
                  ...
                  <div className="col-md-10 media-body">
                    ...
                    >
                      ...
                      institution. From on-page optimisations (meta tags, schema
                      for events/courses, site structure) to off-page efforts
                      (link building with education portals, guest blogging,
                      press releases), we drive organic visibility and reduce
                      your dependence on paid ads.
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="col-md-10 media-body">
                    ...
                    >
                      ...
                      Social Media Ads (Facebook, Instagram, LinkedIn, depending
                      on target segment). Our leads are routed to your
                      CRM/WhatsApp/lead-form with immediate follow-up workflows.
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="col-md-10 media-body">
                    ...
                    >
                      ...
                      stories, live Q&A with faculty, student take-overs, campus
                      events. The goal: build trust, humanise your institution
              ...
              <div className="col-lg-6 d-flex justify-content-center justify-content-md-start">
                ...
                >
                  <div className="col-12 media-image col-md-2 d-flex justify-content-center justify-content-md-center align-items-start">
                    <img
                      src={analyticsIcon}
                      alt="analytics, Reporting & Optimisation icon"
                      width="95%"
                    />
                  </div>
                  <div className="col-md-10 media-body">
                    ...
                    >
                      We believe in data-driven decision-making. You’ll receive
                      clear dashboards tracking: website traffic, lead sources,
                      cost per lead, enrolment conversion rate, student lifetime
                      value (where applicable). Monthly review meetings ensure
                      we optimise campaigns, shift budget to high-performers and
                      refine messaging.
                    </p>
                  </div>
                </div>
        ...
        >
          ...
          <div className="row whyneedRealestate g-4">
        ...
        <div className="service-content LogoVisual pt-4 pb-4">
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6">
                <div data-aos="fade-up" className=" mt-3">
                  <p style={{ textAlign: "left" }}>
                    Ready to give your education institution the digital
                  ...
                  <div className="px-2">
                    ...
                    <div className="">
                      Let’s assess your current marketing performance,
                      competition and digital landscape
                    </div>
                    <div
                      className="my-1"
                      style={{
              ...
              >
                <div className="service-image mt-lg-0 mt-4">
            ...
            <div className="faq-accordion">
              ...
              <div className="faq_container" data-aos="fade-up">
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 1 ? "accordion__item--active" : ""
                    }`}
                  ...
                  >
                    ...
                    {activeIndexLeft === 1 && (
                      <div className="accordion__content fw-normal">
                        NovaTales specializes in student-focused digital
                        marketing strategies designed specifically for schools,
                        colleges, coaching institutes, universities, and online
                        course providers. We help you increase admissions,
                        improve brand trust, build digital visibility, and
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 2 ? "accordion__item--active" : ""
                    }`}
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 3 ? "accordion__item--active" : ""
                    }`}
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 4 ? "accordion__item--active" : ""
                    }`}
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 5 ? "accordion__item--active" : ""
                    }`}
                  ...
                  >
                    ...
                    {activeIndexLeft === 5 && (
                      <div className="accordion__content fw-normal">
                        ...
                        audiences, remarketing, and analytics. This helps
                        attract serious and high-intent prospects rather than
                        generic inquiries.
                      </div>
                    )}
                  </div>
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 6 ? "accordion__item--active" : ""
                    }`}
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 7 ? "accordion__item--active" : ""
                    }`}
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 8 ? "accordion__item--active" : ""
                    }`}
                    onClick={() => toggleAccLeft(8)}
                  >
                    <button className="accordion__btn real-estate-faq">
                      <span className="accordion__caption fw-medium">
                        Can you help us attract students from specific
                        locations?
                      </span>
                      <span className="accordion__icon">
                        <FontAwesomeIcon icon={faPlus} />
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 9 ? "accordion__item--active" : ""
                    }`}
                ...
                <div className="accordion ">
                  <div
                    className={`accordion__item ${
                      activeIndexLeft === 10 ? "accordion__item--active" : ""
                    }`}
                    ...
                    {activeIndexLeft === 10 && (
                      <div className="accordion__content fw-normal">
                        <ul className="mt-0 flex flex-column gap-2">
                          ...
                          <li style={{ listStyleType: "disc" }}>
                            {" "}
                            Tailored marketing plans for each institution
                            size{" "}
                          </li>
                        </ul>
                      </div>

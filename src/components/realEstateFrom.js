...
const RealEstateBookFrom = () => {
    ...
    const handleSubmit = (e) => {
        ...
        try {
            ...
            const formWithPage = { ...formData, page: window.location.href };
             axios.post("/realestate.php", formWithPage).then(
                res => {
    ...
    return (
        <div className="service-content LogoVisual d-flex justify-content-center align-items-center extraPadding mb-2 " >
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-xl-8 d-flex flex-column justify-content-center align-items-center">
                            <div className='row w-100'>
                                ...
                                <div className='col-lg-6 col-xl-3 my-2'>
                                    <input className='form-control w-100 py-2' disabled={loading} type='text' name='businessname' onChange={handleChange} value={formData.businessname} placeholder='Business Name' />
...
export default RealEstateBookFrom;

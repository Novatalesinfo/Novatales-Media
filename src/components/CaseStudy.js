                    ...
                    <Box sx={{ width: '100%', typography: 'body1' }}>
                        <TabContext value={value}>
                            ...
                            <TabPanel value="1" >
                                ...
                                <div data-aos="fade-up" className='row mt-5 mb-3 d-flex flex-lg-row flex-column-reverse align-items-center tab-panel-row'>
                                    <div className='col-lg-6'>
                                        <p style={{
                                            fontSize: "18px", color: "#52377b", padding: "12px 0px"
                                        }}>Digital Marketing</p>
                            ...
                            <TabPanel value="2">
                                <div data-aos="fade-up" data-aos-delay="300" className='row mt-5 mb-3 d-flex flex-lg-row flex-column-reverse align-items-center tab-panel-row'>
                                    <div className='col-lg-6'>
                                        <p style={{
                                            fontSize: "18px", color: "#52377b", padding: "12px 0px",fontFamily: "Poppins" 
                                        }}>Branding</p>
                                        <h3 style={{
                                            color: "#9b499c",
                                ...
                                <div data-aos="fade-up" className='row mt-5 mb-3 d-flex flex-lg-row flex-column-reverse align-items-center tab-panel-row'>
                                    <div className='col-lg-6'>
                                        <p style={{
                                            fontSize: "18px", color: "#52377b", padding: "6px 0px",fontFamily: "Poppins" 
                                        }}>Branding</p>
                                        <h3 style={{
                                            color: "#9b499c",
                                            fontWeight: "500",fontFamily: "Poppins" 
                            ...
                            {/* <TabPanel value="4" sx={{
                                                ...
                                                <div className="service-para mt-3">
                                                    <div className="health-why-novatales text-center realestate-paraheading text-lg-start mt-4 mt-lg-0" style={{
                                                        ...
                                                        <h2 className='fw-bold pb-3' style={{
                                                            color: "#52377b",
                                                            marginLeft: "0px",
                                                            paddingLeft: "0px !important", fontFamily: "Poppins"
                                                        }}>Helping Clients Build Powerful Digital Identities</h2>
                                                    </div>
                                                    <div className='ps-lg-3' style={{
                                                        fontFamily: "Poppins"
                                                    }}>At NovaTales, we believe that a website is more than just a digital storefront; it’s a strategic tool that communicates your values, elevates your brand, and drives growth. Below are recent projects we designed and developed, each with its own challenges, solutions, and outcomes.</div>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 d-flex justify-content-center">
                                ...
                                <div data-aos="fade-up" className='mb-5'>
                                    <h3 className='text-md-start text-center mt-5 mt-md-0' style={{
                                        fontSize: "32px",
                                        color: "#9b499c", fontFamily: "Poppins"
                                    }}>
                                        Endula Infra
                                    </h3>
                                    <p style={{
                                        fontSize: "18px", color: "", padding: "6px 20px 0px" ,fontFamily: "Poppins" 
                                    }}> <span className='fw-bold' style={{
                                        color: "#f3bc50",
                                    }}>Industry : </span> Infrastructure</p>
                                    <div className='inside-tab-child-div' style={{
                                        padding: "0px !important", fontFamily: "Poppins"
                                    }} >
                                        <p style={{
                                            paddingLeft: "px !important",
                                            paddingBottom: "10px", fontFamily: "Poppins"
                                        }} className='' >
                                            Endula Infra is a Stone Crushing Industry based in Hyderabad and has been in existence for more than three decades, placing the company as an industry legend in Stone crushing.
                                        </p>
                                ...
                                <div style={{
                                    ...
                                    <h3 className='text-md-start text-center' style={{
                                        fontSize: "32px",
                                        fontWeight: "bold",
                                        padding: "12px 14px 0px", color: "#52377b", fontFamily: "Poppins"
                                    }}>
                                        How Novatales Delivers Value
                                    </h3>
                                    <div className='px-3'>
                                        <p style={{
                                            fontSize: "16px", padding: "12px 0px 12px 0", fontFamily: "Poppins"
